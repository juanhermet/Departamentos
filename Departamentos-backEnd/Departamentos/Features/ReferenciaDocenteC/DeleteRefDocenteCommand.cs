...
{
    public class DeleteRefDocenteCommand
    {
        ...
        public class Handler : IRequestHandler<Command>
        {
            ...
            {
                var toRemove = _DatabaseContext.ReferenciaDocentes.Where(element => element.Id == request.Id);
                _DatabaseContext.ReferenciaDocentes.RemoveRange(toRemove);
