...
{
    public class UpdateTipoCargoCommand
    {
        ...
        public class CommandValidator : AbstractValidator<Command>
        {
            ...
            public CommandValidator(DepartamentosContext databaseContext)
            {
                ...
                RuleFor(command => command.Id)
                   ...
                   {
                       return await _DatabaseContext.TipoCargos.AnyAsync
                ...
                RuleFor(command => command.Tipo)
                   .MustAsync(async (tipo, cancelToken) =>
                   {
                       ...
                       .WithMessage("Ya existe un tipo de cargo con ese nombre.");
            }
        }
        ...
        public class Handler : IRequestHandler<Command, CommandResult>
        {
            ...
            public async Task<CommandResult> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                _DatabaseContext.TipoCargos.Update(foundElement);
            ...
            private TipoCargo alterElement(Command request)
            {
                var entity = _DatabaseContext.TipoCargos.Find(request.Id);
