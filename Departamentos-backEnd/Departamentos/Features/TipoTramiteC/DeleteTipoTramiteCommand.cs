...
{
    public class DeleteTipoTramiteCommand
    {
        ...
        public class Handler : IRequestHandler<Command>
        {
            ...
            {
                var toRemove = _DatabaseContext.TipoTramites.Where(element => element.Id == request.Id);
                _DatabaseContext.TipoTramites.RemoveRange(toRemove);
